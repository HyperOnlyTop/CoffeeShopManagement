...
/**
 * Seed đơn hàng và đặt bàn mẫu (idempotent: mã đơn cố định; booking theo cặp SĐT + giờ đặt).
 * Đơn khoảng 28/3–3/4; lịch đặt bàn dày 28/3–3/4 (mỗi {@code booking_time} duy nhất toàn DB).
 * Trạng thái {@link OrderStatus#COMPLETED} / {@link BookingStatus#COMPLETED} cho dữ liệu lịch sử.
 */
@Component
public class OrderAndBookingDataSeeder {
     ...
     * Mã SEED-YYYYMMDD-xx — idempotent.
     */
    private void seedOrdersMar28ThroughApr3_2026() {
        List<RangeDayOrder> mar28 = List.of(
                new RangeDayOrder("SEED-20260328-01", 7, 18, true, 2, "Dương Thế Vinh", "0906280101",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Espresso", "1", null }, { "Sandwich gà", "1", null } }),
                new RangeDayOrder("SEED-20260328-02", 10, 22, false, null, "Nguyễn Thị Lam", "0906280102",
                        "Mang đi", PaymentMethod.CARD,
                        new String[][] { { "Trà sữa truyền thống", "2", "Ít đá" } }),
                new RangeDayOrder("SEED-20260328-03", 13, 40, true, 8, "Hoàng Anh Tuấn", "0906280103",
                        null, PaymentMethod.BANK_TRANSFER,
                        new String[][] { { "Latte", "1", null }, { "Sandwich trứng", "1", null } }),
                new RangeDayOrder("SEED-20260328-04", 16, 55, false, null, "Lê Khánh Ngọc", "0906280104",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Soda chanh", "1", null }, { "Khoai tây chiên", "1", null } }),
                new RangeDayOrder("SEED-20260328-05", 20, 5, true, 13, null, null,
                        "Khách vãng lai", PaymentMethod.CASH,
                        new String[][] { { "Bạc xỉu", "2", null } }));

        List<RangeDayOrder> mar29 = List.of(
                new RangeDayOrder("SEED-20260329-01", 7, 45, false, null, "Phạm Gia Bảo", "0906290101",
                        "Sáng thứ bảy", PaymentMethod.CASH,
                        new String[][] { { "Americano", "2", null } }),
                new RangeDayOrder("SEED-20260329-02", 11, 5, true, 4, "Vũ Thùy Dương", "0906290102",
                        null, PaymentMethod.CARD,
                        new String[][] { { "Cappuccino", "1", null }, { "Pain au chocolat", "1", null } }),
                new RangeDayOrder("SEED-20260329-03", 14, 28, false, null, "Đặng Minh Quân", "0906290103",
                        "Lấy ngay", PaymentMethod.CASH,
                        new String[][] { { "Trà chanh mật ong", "1", null }, { "Brownie", "1", null } }),
                new RangeDayOrder("SEED-20260329-04", 17, 42, true, 16, "Trương Nhã Uyên", "0906290104",
                        "Họp nhóm", PaymentMethod.BANK_TRANSFER,
                        new String[][] { { "Cold Brew", "3", null } }),
                new RangeDayOrder("SEED-20260329-05", 20, 18, true, 6, "Bùi Sơn Tùng", "0906290105",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Mocha", "1", null }, { "Cheesecake", "1", null } }));

        List<RangeDayOrder> mar30 = List.of(
                new RangeDayOrder("SEED-20260330-01", 7, 30, true, 1, "Đỗ Quỳnh Chi", "0906300101",
                        "Gần quầy bar", PaymentMethod.CARD,
                        new String[][] { { "Cà phê sữa đá", "1", null } }),
                new RangeDayOrder("SEED-20260330-02", 10, 48, false, null, "Hồ Nam Phong", "0906300102",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Matcha Latte", "1", null }, { "Croissant bơ", "1", null } }),
                new RangeDayOrder("SEED-20260330-03", 13, 12, true, 11, "Lý Bảo Ngân", "0906300103",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Trà đào cam sả", "2", null } }),
                new RangeDayOrder("SEED-20260330-04", 17, 8, false, null, "Châu Bảo Long", "0906300104",
                        "Không nhận marketing", PaymentMethod.BANK_TRANSFER,
                        new String[][] { { "Chocolate đá", "1", null }, { "Tiramisu", "1", null } }),
                new RangeDayOrder("SEED-20260330-05", 20, 48, true, 19, null, null,
                        null, PaymentMethod.CARD,
                        new String[][] { { "Sinh tố bơ", "1", null }, { "Hạt mix", "1", null } }));

        List<RangeDayOrder> mar31 = List.of(
                new RangeDayOrder("SEED-20260331-01", 7, 12, true, 4, "Ngô Thảo Vy", "0907001001",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Espresso", "1", null }, { "Croissant bơ", "1", null } }),
                new RangeDayOrder("SEED-20260331-02", 10, 35, false, null, "Trịnh Bảo Long", "0907001002",
                        "Mang đi — nóng", PaymentMethod.CARD,
                        new String[][] { { "Latte", "2", null } }),
                new RangeDayOrder("SEED-20260331-03", 13, 48, true, 9, "Lý Minh Tuấn", "0907001003",
                        null, PaymentMethod.BANK_TRANSFER,
                        new String[][] { { "Trà đào cam sả", "2", null }, { "Sandwich gà", "1", null } }),
                new RangeDayOrder("SEED-20260331-04", 17, 5, false, null, "Chu Diệu Linh", "0907001004",
                        "Lấy sau 15 phút", PaymentMethod.CASH,
                        new String[][] { { "Cold Brew", "1", null }, { "Brownie", "2", null } }),
                new RangeDayOrder("SEED-20260331-05", 20, 22, true, 14, null, null,
                        "Khách ngồi lâu", PaymentMethod.CARD,
                        new String[][] { { "Mocha", "1", null }, { "Cheesecake", "1", null } }));

        List<RangeDayOrder> apr1 = List.of(
                new RangeDayOrder("SEED-20260401-01", 7, 40, false, null, "Hồ Ngọc Sơn", "0908002001",
                        "Sáng sớm", PaymentMethod.CASH,
                        new String[][] { { "Americano", "2", null } }),
                new RangeDayOrder("SEED-20260401-02", 11, 8, true, 6, "Đinh Khánh Ly", "0908002002",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Cappuccino", "1", null }, { "Pain au chocolat", "1", null } }),
                new RangeDayOrder("SEED-20260401-03", 14, 25, false, null, "Mai Phương Anh", "0908002003",
                        null, PaymentMethod.BANK_TRANSFER,
                        new String[][] { { "Matcha Latte", "1", "Ít ngọt" }, { "Sinh tố xoài", "1", null } }),
                new RangeDayOrder("SEED-20260401-04", 18, 50, true, 11, "Vũ Hoàng Nam", "0908002004",
                        "Cuối giờ", PaymentMethod.CARD,
                        new String[][] { { "Bạc xỉu", "2", null } }),
                new RangeDayOrder("SEED-20260401-05", 20, 40, false, null, "Phan Thu Trang", "0908002005",
                        "Order cuối ngày", PaymentMethod.CASH,
                        new String[][] { { "Chocolate nóng", "1", null }, { "Tiramisu", "1", null } }));

        List<RangeDayOrder> apr2 = List.of(
                new RangeDayOrder("SEED-20260402-01", 7, 25, false, null, "Cao Thị Yến", "0909003001",
                        "Mang đi nhanh", PaymentMethod.CARD,
                        new String[][] { { "Cà phê trứng", "1", null } }),
                new RangeDayOrder("SEED-20260402-02", 10, 50, true, 3, "Lương Đức Thắng", "0909003002",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Trà vải", "2", null }, { "Khoai tây chiên", "1", null } }),
                new RangeDayOrder("SEED-20260402-03", 14, 2, false, null, "Tôn Nữ Minh Châu", "0909003003",
                        null, PaymentMethod.BANK_TRANSFER,
                        new String[][] { { "Cold Brew cam", "1", null }, { "Muffin việt quất", "1", null } }),
                new RangeDayOrder("SEED-20260402-04", 17, 35, true, 10, "Quách Hải Đăng", "0909003004",
                        "Gần ổ cắm", PaymentMethod.CASH,
                        new String[][] { { "Mocha Frappe", "1", null } }),
                new RangeDayOrder("SEED-20260402-05", 20, 8, true, 8, null, null,
                        "Khách ghé muộn", PaymentMethod.CARD,
                        new String[][] { { "Americano", "1", null }, { "Sandwich trứng", "1", null } }));

        List<RangeDayOrder> apr3 = List.of(
                new RangeDayOrder("SEED-20260403-01", 7, 50, true, 5, "Kiều Anh Thư", "0910004001",
                        "Sáng thứ 5", PaymentMethod.CASH,
                        new String[][] { { "Cappuccino", "1", null }, { "Croissant bơ", "1", null } }),
                new RangeDayOrder("SEED-20260403-02", 11, 22, false, null, "Bạch Dương", "0910004002",
                        null, PaymentMethod.CARD,
                        new String[][] { { "Nước ép cam", "2", null } }),
                new RangeDayOrder("SEED-20260403-03", 13, 55, true, 15, "Hà Kiều My", "0910004003",
                        null, PaymentMethod.CASH,
                        new String[][] { { "Matcha Cloud", "1", null }, { "Salad ức gà", "1", null } }),
                new RangeDayOrder("SEED-20260403-04", 17, 18, false, null, "Giáp Tuấn Kiệt", "0910004004",
                        "Không ống hút", PaymentMethod.BANK_TRANSFER,
                        new String[][] { { "Soda đào", "1", null }, { "Gà nuggets", "1", null } }),
                new RangeDayOrder("SEED-20260403-05", 20, 35, true, 1, "La Ngọc Hân", "0910004005",
    ...
    private void seedDemoOrders() {
        seedOrderDineIn(
                ...
                LocalDateTime.of(2026, 3, 10, 9, 42),
                LocalDateTime.of(2026, 3, 10, 9, 50),
                "Trần Minh Khoa",
                "0901111222",
                3,
                "Ít đá",
                PaymentMethod.CASH,
                new String[][] { { "Latte", "2", null }, { "Croissant bơ", "1", null } });

        seedOrderTakeaway(
                "SEED-ORD-02",
                LocalDateTime.of(2026, 3, 11, 14, 5),
                LocalDateTime.of(2026, 3, 11, 14, 18),
                LocalDateTime.of(2026, 3, 11, 14, 25),
                "Lê Thu Hà",
                "0902222333",
                "Lấy tại quầy — ly giấy",
                PaymentMethod.CARD,
                new String[][] { { "Cappuccino", "1", null }, { "Trà đào cam sả", "2", "Ít đường" } });

        seedOrderDineIn(
                "SEED-ORD-03",
                LocalDateTime.of(2026, 3, 14, 16, 0),
                LocalDateTime.of(2026, 3, 14, 16, 12),
                LocalDateTime.of(2026, 3, 14, 16, 20),
                "Phạm Quốc An",
                "0903333444",
                12,
                null,
                PaymentMethod.BANK_TRANSFER,
                new String[][] { { "Americano", "2", null }, { "Brownie", "1", null } });

        seedOrderDineInWalkIn(
                "SEED-ORD-04",
                LocalDateTime.of(2026, 3, 18, 11, 15),
                LocalDateTime.of(2026, 3, 18, 11, 28),
                LocalDateTime.of(2026, 3, 18, 11, 35),
                7,
                "Góc yên tĩnh",
                PaymentMethod.CASH,
                new String[][] { { "Matcha Latte", "1", null }, { "Tiramisu", "1", null } });

        seedOrderTakeaway(
                "SEED-ORD-05",
                LocalDateTime.of(2026, 3, 22, 8, 40),
                LocalDateTime.of(2026, 3, 22, 8, 52),
                LocalDateTime.of(2026, 3, 22, 8, 55),
                "Đỗ Văn Hùng",
                "0904444555",
                "Giao Grab — để ở lễ tân",
                PaymentMethod.CASH,
                new String[][] { { "Cà phê sữa đá", "2", null } });
    }
    ...
    private void seedOrderDineInWalkIn(
            String orderCode,
            LocalDateTime createdAt,
            LocalDateTime preparedAt,
            LocalDateTime paidAt,
     ...
     * Giờ đặt trong khung hoạt động (sớm nhất 8:30, muộn nhất 21:00), mỗi {@code booking_time} duy nhất toàn DB.
    ...
    private void seedBookingsMar28ThroughApr3_2026() {
        ...
        seq = seedCalendarBookings(2026, 3, 28, seq, List.of(
                new CalSlot(10, 15, 2, 5, "Trần Thu Hương", "huong.tran@demo.local", "Uống trà chiều"),
                new CalSlot(12, 25, 4, 7, "Lê Quốc Huy", "huy.le@demo.local", "Sinh nhật bạn"),
                new CalSlot(15, 45, 3, null, "Phạm Ngọc Lan", null, "Chưa chọn bàn — linh hoạt"),
                new CalSlot(18, 20, 8, 12, "Hoàng Đức Anh", "anh.hoang@demo.local", "Họp nhóm lớn"),
                new CalSlot(20, 50, 2, 3, "Võ Thị Mai", null, "Cuối ngày, yên tĩnh")));
        seq = seedCalendarBookings(2026, 3, 29, seq, List.of(
                new CalSlot(9, 40, 3, 4, "Đặng Minh Khôi", "khoi.dang@demo.local", "Brunch cuối tuần"),
                new CalSlot(11, 55, 2, 6, "Bùi Thảo My", null, "Gần cửa sổ"),
                new CalSlot(14, 10, 5, 9, "Nguyễn Hải Nam", "nam.nguyen@demo.local", "Có trẻ nhỏ"),
                new CalSlot(17, 35, 6, 11, "Đinh Thuỳ Linh", "linh.dinh@demo.local", "Tiệc nhỏ"),
                new CalSlot(19, 48, 4, 8, "Mai Phương Đông", null, "Tối thứ bảy")));
        seq = seedCalendarBookings(2026, 3, 30, seq, List.of(
                new CalSlot(8, 30, 2, 2, "Lý Gia Hân", "han.ly@demo.local", "Sáng sớm"),
                new CalSlot(12, 5, 3, 10, "Chu Bảo Long", null, "Trưa vắng"),
                new CalSlot(15, 18, 7, 14, "Tôn Nữ Ánh Tuyết", "tuyet.book@demo.local", "Họp team"),
                new CalSlot(17, 52, 2, 5, "Cao Hoài Nam", null, "Hẹn gặp bạn"),
                new CalSlot(20, 8, 4, 16, "Kiều Bích Ngọc", "ngoc.kieu@demo.local", "Tối xem bóng đá")));
        seq = seedCalendarBookings(2026, 3, 31, seq, List.of(
                new CalSlot(10, 5, 3, 6, "Quách Đình Phúc", "phuc.quach@demo.local", "Cuối tháng"),
                new CalSlot(13, 22, 5, 13, "Hà Thu Trang", null, "Họp phụ huynh xong"),
                new CalSlot(16, 8, 2, 1, "La Tuấn Kiệt", "kiet.la@demo.local", null),
                new CalSlot(18, 40, 8, 18, "Giáp Thị Yến", null, "Tiệc chia tay đồng nghiệp"),
                new CalSlot(21, 0, 3, 4, "Phan Bảo Châu", "chau.phan@demo.local", "Slot muộn")));
        seq = seedCalendarBookings(2026, 4, 1, seq, List.of(
                new CalSlot(9, 15, 2, 3, "Vương Thế Sơn", "son.vuong@demo.local", "Cà phê sáng 1/4"),
                new CalSlot(12, 40, 6, 15, "Thân Minh Tuấn", null, "Đông người"),
                new CalSlot(15, 30, 4, 7, "Uông Thị Hạnh", "hanh.uong@demo.local", "Chiều mát"),
                new CalSlot(18, 12, 2, 2, "Dương Kim Ngân", null, "Đi một mình"),
                new CalSlot(20, 25, 5, 17, "Từ Đức Thịnh", "thinh.tu@demo.local", "Tối muộn")));
        seq = seedCalendarBookings(2026, 4, 2, seq, List.of(
                new CalSlot(10, 35, 3, 8, "Hồ Ngọc Bích", null, "Thử cold brew"),
                new CalSlot(13, 15, 4, 9, "Lương Văn Tài", "tai.luong@demo.local", "Họp dự án"),
                new CalSlot(16, 45, 2, 5, "Tạ Minh Tuệ", null, "Góc làm việc"),
                new CalSlot(18, 55, 7, 12, "Đỗ Quang Huy", "huy.do@demo.local", "Nhóm bạn đông"),
                new CalSlot(20, 38, 3, 6, "Âu Dương Phong", null, "Sau xem phim")));
        seedCalendarBookings(2026, 4, 3, seq, List.of(
                new CalSlot(11, 8, 4, 10, "Khúc Anh Thư", "thu.khuc@demo.local", "Trưa Chủ nhật"),
                new CalSlot(14, 42, 2, 3, "Tiêu Việt Hùng", null, "Thư giãn"),
                new CalSlot(17, 18, 6, 11, "Chế Linh Phụng", "phung.che@demo.local", "Sinh nhật con"),
                new CalSlot(19, 5, 3, 14, "Viên Hoài Thương", null, "Gặp bạn cũ"),
                new CalSlot(20, 55, 5, 19, "Tô Hiếu Nghĩa", "nghia.to@demo.local", "Khách quen — bàn quen")));
    }
    ...
    private int seedCalendarBookings(int year, int month, int day, int phoneSeq, List<CalSlot> slots) {
        ...
        for (CalSlot s : slots) {
            ...
            int jitter = 8 + (n % 41);
            LocalDateTime createdAt = bookingTime.minusDays(1).withHour(9).withMinute(Math.min(jitter, 55));
            if (!createdAt.isBefore(bookingTime)) {
                createdAt = bookingTime.minusHours(3);
            }
